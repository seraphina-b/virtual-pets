...
con.connect(function(err) {
  ...
  let sql =
    "DROP TABLE if exists pets; CREATE TABLE pets(petID INT NOT NULL AUTO_INCREMENT, name VARCHAR(255), dateCreated DATETIME, satiety INT NOT NULL DEFAULT 0, happy INT NOT NULL DEFAULT 0, clean INT NOT NULL DEFAULT 0, play INT NOT NULL DEFAULT 0, sick INT NOT NULL DEFAULT 0, timeFed DATETIME, PRIMARY KEY (petID));";
